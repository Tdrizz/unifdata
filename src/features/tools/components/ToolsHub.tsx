...
function IconZap() { return <svg width={22} height={22} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>; }
...
export function ToolsHub({ profile, pendingProposals = 0 }: { profile: IndustryProfile; pendingProposals?: number }) {
  const cards: ToolCard[] = [
    ...
    },
    {
      href: "/automations",
      title: "Automations",
      description: "Rules that fire on their own as records change.",
      icon: <IconZap />,
    },
    {
      href: "/process",
  ...
  return (
    <div className="px-5 pt-6 pb-12 md:px-8 md:pt-7">
      <PageHeader
        eyebrow="Tools"
        title="Tools"
        description="Everything else that runs behind the scenes — data quality, automations, imports, and custom boards."
        className="mb-6"
      />
