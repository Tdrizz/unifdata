      ...
      <div className="flex items-center gap-[2px] bg-ud-surface-sunk border border-ud rounded-[9px] p-[3px] w-fit">
        {filterTabs.map((tab) => (
          <Link
            ...
            href={tab.href}
            className={cn(
              "inline-flex items-center gap-1.5 px-[13px] py-[5px] rounded-[7px] text-[12.5px] font-semibold whitespace-nowrap transition-[color,background-color,box-shadow] duration-[120ms] ease-out",
            ...
            <EmptyState
              ...
              action={
                <div className="flex flex-wrap items-center gap-2 justify-center">
                  <a href="/follow-ups/new" className="inline-flex items-center gap-1.5 font-semibold text-[13px] px-3 py-2 rounded-[9px] bg-ud-accent text-white hover:opacity-90 transition-opacity">
