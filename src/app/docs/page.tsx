  ...
  return (
    <main className="min-h-screen bg-ud-page text-ud-ink">
      ...
      <div className="mx-auto max-w-7xl px-6 py-20">
        <div className="inline-flex items-center gap-2 rounded-full border border-ud bg-ud-surface px-4 py-1.5 text-[13px] font-medium text-ud-muted">
          <span className="h-1.5 w-1.5 rounded-full bg-ud-accent" />
          UnifData Docs
        </div>
        <h1 className="mt-5 max-w-4xl text-[38px] font-semibold leading-[1.05] tracking-tight md:text-5xl text-ud-ink">
          Documentation for the business operating system.
        </h1>
        <p className="mt-5 max-w-3xl text-[16px] leading-[1.7] text-ud-text">
      ...
      <div className="border-t border-ud">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid grid-cols-1 gap-8 py-8 lg:grid-cols-[240px_1fr]">
            {/* Sidebar */}
            <aside className="h-fit rounded-[14px] border border-ud bg-ud-surface p-4 lg:p-5 lg:sticky lg:top-[72px]">
              <p className="text-[12px] font-semibold text-ud-text">Contents</p>
              <div className="mt-3 flex gap-1.5 overflow-x-auto no-scrollbar text-[13px] lg:grid lg:gap-0.5 lg:overflow-visible">
                {navItems.map(([label, href]) => (
                  <a
                    key={href}
                    href={href}
                    className="whitespace-nowrap rounded-full border border-ud px-3.5 py-1.5 font-medium text-ud-muted hover:bg-ud-surface-sunk hover:text-ud-ink transition-colors lg:whitespace-normal lg:rounded-[8px] lg:border-0 lg:px-3 lg:py-2"
                  >
                    {label}
                  </a>
                ))}
            ...
            <div className="divide-y divide-ud">
              ...
              <section id="start" className="scroll-mt-20 py-10">
                ...
                <p className="mt-4 text-[13.5px] leading-[1.7] text-ud-text">
                ...
                <div className="mt-5 rounded-[12px] border border-ud-accent/25 bg-ud-accent/[0.06] px-5 py-4">
                  <p className="text-[13px] font-semibold text-ud-accent">Tip: Start with your customer list</p>
                  <p className="mt-1 text-[13px] leading-[1.65] text-ud-text">
              ...
              <section id="overview" className="scroll-mt-20 py-10">
                <h2 className="text-[24px] font-semibold text-ud-ink">Overview</h2>
                <p className="mt-4 text-[13.5px] leading-[1.7] text-ud-text">
                ...
                <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-3">
                  {[
                    ...
                    <div key={item.title} className="rounded-[14px] border border-ud bg-ud-surface p-5">
                      <p className="text-[14px] font-semibold text-ud-ink">{item.title}</p>
                      <p className="mt-2 text-[13px] leading-[1.65] text-ud-text">{item.description}</p>
                    </div>
                  ))}
                </div>
              </section>
              ...
              <section id="lifecycle" className="scroll-mt-20 py-10">
                <h2 className="text-[24px] font-semibold text-ud-ink">Core lifecycle</h2>
                <p className="mt-4 text-[13.5px] leading-[1.7] text-ud-text">
                ...
                <div className="mt-6 grid gap-3">
                  {lifecycle.map((item, index) => (
                    <div
                      key={item.title}
                      className="grid grid-cols-1 gap-4 rounded-[14px] border border-ud bg-ud-surface p-5 md:grid-cols-[56px_1fr_auto] md:items-center"
                    >
                      <div className="flex h-10 w-10 items-center justify-center rounded-[10px] bg-ud-surface-sunk text-[13px] font-semibold text-ud-ink">
                        {index + 1}
                      </div>
                      <div>
                        <p className="text-[14px] font-semibold text-ud-ink">{item.title}</p>
              ...
              <section id="pages" className="scroll-mt-20 py-10">
                <h2 className="text-[24px] font-semibold text-ud-ink">Product pages</h2>
                <p className="mt-4 text-[13.5px] leading-[1.7] text-ud-text">
                ...
                <div className="mt-6 grid grid-cols-1 gap-3 md:grid-cols-2">
                  {pages.map((page) => (
                    <div key={page.path} className="rounded-[14px] border border-ud bg-ud-surface p-5">
                      <div className="flex flex-wrap items-center justify-between gap-x-3 gap-y-2">
                        <p className="text-[14px] font-semibold text-ud-ink">{page.name}</p>
                        <div className="flex items-center gap-2">
                          <span className="rounded-full bg-ud-accent/[0.12] px-2.5 py-0.5 text-[11px] font-semibold text-ud-accent">
                            {page.tag}
                          </span>
                          <code className="rounded-[6px] border border-ud bg-ud-surface-sunk px-2.5 py-1 text-[11px] font-semibold text-ud-muted">
                            {page.path}
                          </code>
                        </div>
                      </div>
                      <p className="mt-3 text-[13px] leading-[1.65] text-ud-text">{page.description}</p>
                    </div>
                  ))}
                </div>
              </section>
              ...
              <section id="vera" className="scroll-mt-20 py-10">
                <h2 className="text-[24px] font-semibold mb-4 text-ud-ink">Vera</h2>
                <p className="text-[13.5px] leading-[1.7] text-ud-text mb-6">
                ...
                <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
                  {[
                    ...
                    <div key={item.title} className="rounded-[14px] border border-ud bg-ud-surface p-5">
                      <p className="text-[14px] font-semibold mb-2 text-ud-ink">{item.title}</p>
                      <p className="text-[13px] leading-[1.65] text-ud-text">{item.body}</p>
                    </div>
                  ))}
                </div>
                <div className="mt-4 rounded-[12px] border border-ud-accent/25 bg-ud-accent/[0.06] px-5 py-4">
              ...
              <section id="industries" className="scroll-mt-20 py-10">
                <h2 className="text-[24px] font-semibold text-ud-ink">Industry-aware language</h2>
                <p className="mt-4 text-[13.5px] leading-[1.7] text-ud-text">
                ...
                <div className="mt-6 overflow-hidden rounded-[14px] border border-ud">
                  ...
                  {sectors.map((item, i) => (
                    <div
                      key={item.sector}
                      className={`grid grid-cols-1 gap-3 px-5 py-4 md:grid-cols-[200px_1fr] ${i % 2 === 0 ? "bg-ud-page" : "bg-ud-surface"}`}
                    >
                      <p className="text-[13.5px] font-semibold text-ud-ink">{item.sector}</p>
                      <p className="text-[13px] leading-[1.6] text-ud-text">{item.wording}</p>
                    </div>
                  ))}
                </div>
              </section>
              ...
              <section id="sync" className="scroll-mt-20 py-10">
                <h2 className="text-[24px] font-semibold text-ud-ink">Connected workflow</h2>
                <p className="mt-4 text-[13.5px] leading-[1.7] text-ud-text">
                ...
                <div className="mt-6 overflow-hidden rounded-[14px] border border-ud bg-ud-surface">
                  <div className="grid grid-cols-1 divide-y divide-ud md:grid-cols-3 md:divide-x md:divide-y-0">
                    {[
                ...
                <div className="mt-4 rounded-[12px] border border-amber-300/60 bg-amber-50 px-5 py-4">
                  <p className="text-[13px] font-semibold text-amber-700">Payment status is always separate</p>
                  <p className="mt-1 text-[13px] leading-[1.65] text-ud-text">
              ...
              <section id="integrations" className="scroll-mt-20 py-10">
                <h2 className="text-[24px] font-semibold text-ud-ink">Integrations</h2>
                <p className="mt-4 text-[13.5px] leading-[1.7] text-ud-text">
                  ...
                  <Link href="/settings" className="font-semibold text-ud-ink hover:underline">Settings</Link>.
                </p>

                <div className="mt-6 grid grid-cols-1 gap-3 md:grid-cols-2">
                  {integrations.map((integration) => (
                    <div key={integration.name} className="rounded-[14px] border border-ud bg-ud-surface p-5">
                      <div className="flex items-center justify-between gap-3">
                        <p className="text-[14px] font-semibold text-ud-ink">{integration.name}</p>
                        <span className="rounded-full bg-ud-success-bg px-2.5 py-0.5 text-[11px] font-semibold text-ud-success">
                          {integration.status}
                        </span>
                      </div>
                      <p className="mt-3 text-[13px] leading-[1.65] text-ud-text">{integration.description}</p>
                    </div>
                  ))}
                </div>

                <div className="mt-5 overflow-hidden rounded-[14px] border border-ud bg-ud-surface">
                  <div className="grid grid-cols-1 divide-y divide-ud p-0 md:grid-cols-3 md:divide-x md:divide-y-0">
                    {[
              ...
              <section id="imports" className="scroll-mt-20 py-10">
                <h2 className="text-[24px] font-semibold text-ud-ink">Imports</h2>
                <p className="mt-4 text-[13.5px] leading-[1.7] text-ud-text">
                ...
                <div className="mt-6 overflow-hidden rounded-[14px] border border-ud">
                  ...
                  {csvColumns.map((col, i) => (
                    <div
                      key={col.column}
                      className={`grid grid-cols-1 gap-2 px-5 py-4 text-[13px] md:grid-cols-[140px_80px_1fr_160px] ${i % 2 === 0 ? "bg-ud-page" : "bg-ud-surface"}`}
                    >
                      <code className="font-semibold text-ud-ink">{col.column}</code>
                      <span>
                        {col.required ? (
                          <span className="rounded-full bg-ud-accent/[0.14] px-2.5 py-0.5 text-[11px] font-semibold text-ud-accent">
                            Required
                          </span>
                        ) : (
                          <span className="rounded-full border border-ud px-2.5 py-0.5 text-[11px] font-medium text-ud-muted">
                            Optional
                          </span>
                        )}
                      </span>
                ...
                <p className="mt-5 text-[13px] font-semibold text-ud-ink">Example CSV</p>
                <pre className="mt-2 overflow-x-auto rounded-[14px] border border-ud bg-ud-surface-sunk p-5 text-[13px] leading-[1.7] text-ud-text">{`name,phone,email,address,customer_type,notes\nMike Johnson,808-555-0110,mike@example.com,Kailua-Kona HI,Residential,Interested in monthly service`}</pre>
              </section>


              <section id="contacts" className="scroll-mt-20 py-10">
                <h2 className="text-[24px] font-semibold text-ud-ink">Contacts</h2>
                <p className="mt-4 text-[13.5px] leading-[1.7] text-ud-text">
      ...
      {/* CTA */}
      <div className="border-t border-ud px-6 py-20 text-center">
        <div className="mx-auto max-w-2xl">
          <h2 className="text-[30px] font-semibold tracking-tight text-ud-ink">Ready to build the workspace?</h2>
          <p className="mt-3 text-[15px] text-ud-text">
            Create a company, pick the business sector, and start organizing the operating side of the business.
          </p>
          <div className="mt-7 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <Link href="/waitlist" className="rounded-xl bg-ud-ink px-6 py-3 font-semibold text-white hover:opacity-85 transition-opacity">
              Create workspace
            </Link>
            <Link href="/preview" className="rounded-xl border border-ud-hard px-6 py-3 font-semibold text-ud-ink hover:bg-ud-surface-sunk transition-colors">
              View preview
            </Link>
          </div>
        </div>
      ...
      <footer className="border-t border-ud px-6 py-8">
        <div className="mx-auto flex max-w-7xl flex-col gap-3 text-[13px] text-ud-faint md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex gap-5">
            ...
            <Link href="/pricing" className="hover:text-ud-ink transition-colors">Pricing</Link>
          </div>
        </div>
      </footer>
    </main>
