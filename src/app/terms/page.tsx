        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="space-y-6 text-sm leading-7 text-slate-700">
            <div>
              ...
              <p className="mt-2">
                By using UnifData, you agree to these Terms of Service. If
            ...
            <div>
              ...
              <p className="mt-2">
                UnifData is a business operations platform for organizing
                customer records, opportunities, work, revenue, follow-ups,
                imports, and AI-generated operating briefs. UnifData may
            ...
            <div>
              ...
              <p className="mt-2">
                UnifData may be offered as an early-stage, beta, or pilot
            ...
            <div>
              ...
              <p className="mt-2">
                ...
                add or import into UnifData, protecting your account access,
            ...
            <div>
              ...
              <p className="mt-2">
                ...
                authorize UnifData to access the Google files or spreadsheets
                you choose to use with the service. UnifData uses that access
            ...
            <div>
              ...
              <p className="mt-2">
                ...
                inaccurate. UnifData does not provide legal, financial,
            ...
            <div>
              ...
              <p className="mt-2">
                You may not use UnifData to violate laws, infringe the rights
            ...
            <div>
              ...
              <p className="mt-2">
                UnifData may connect with third-party services such as Google
            ...
            <div>
              ...
              <p className="mt-2">
                UnifData may change, suspend, or discontinue features at any
            ...
            <div>
              ...
              <p className="mt-2">
                UnifData is provided on an “as is” and “as available” basis.
                To the maximum extent allowed by law, UnifData is not liable
