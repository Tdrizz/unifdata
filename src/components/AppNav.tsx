...
function IconLayers() { return <svg width={15} height={15} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/></svg>; }
...
function IconZap() { return <svg width={15} height={15} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>; }
...
export function AppNav({
  ...
  const workspaceItems: NavItem[] = [
    ...
    { href: "/process",    label: profile.recordPlural,            icon: <IconLayers />,    match: (p) => p === "/process" },
    { href: "/communications", label: "Communications",            icon: <IconMessage />,   match: (p) => p === "/communications" },
  ];
  ...
  const intelligenceItems: NavItem[] = [
    ...
    { href: "/automations", label: "Automations", icon: <IconZap />, match: (p) => p === "/automations" },
