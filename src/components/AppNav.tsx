  ...
  return [
    {
      ...
      items: [
        ...
        { href: "/leads",      label: profile.labels.leadPlural,                       icon: IconBriefcase },
    ...
    <div className="flex flex-col">
      ...
      {groups.map((group) => (
        <div key={group.label} className="mb-2">
          <p className="mb-1 px-[9px] text-[10px] font-bold uppercase tracking-widest text-[#3d5166]">
            {group.label}
          </p>
            ...
            {group.items.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {item.badge && (
                    <span className={cn(
                      "text-[10.5px] font-bold rounded-[4px] px-[5px] py-[1px] leading-none",
