...
export function AppNav({
  ...
  // One dashboard (Home), one merged Pipeline (leads/jobs/sales, with
  // follow-ups folded in as per-card actions), Contacts, and
  // Communications -- everything else (Vera, Data Hub, Imports) is either
  // folded into Home (Vera) or reachable through the single Tools entry
  // below, instead of each being a co-equal top-level destination.
