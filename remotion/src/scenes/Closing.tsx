...
const features = [
  "Pipeline & relationships", "Smart data imports", "AI operating brief",
  "Industry-aware workspace", "Opportunity lifecycle sync", "Data quality hub",
];
  ...
  return (
    <AbsoluteFill style={{ background: "#0a0f1e" }}>
      <AbsoluteFill style={{ display: "flex", alignItems: "center", justifyContent: "center", pointerEvents: "none" }}>
        <div style={{ width: 700, height: 700, borderRadius: "50%", background: "radial-gradient(circle, rgba(37,99,235,0.14) 0%, rgba(139,92,246,0.08) 40%, transparent 70%)", opacity: glowOpacity }} />
      </AbsoluteFill>
      <AbsoluteFill style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 36, padding: "0 120px" }}>
        <div style={{ opacity: logoOpacity, transform: `scale(${logoScale})`, display: "flex", alignItems: "center", gap: 16 }}>
          <svg width="56" height="56" viewBox="0 0 72 72" fill="none">
            ...
            <rect x="14" y="20" width="44" height="6" rx="3" fill="white" opacity="0.9" />
            <rect x="14" y="33" width="32" height="6" rx="3" fill="white" opacity="0.7" />
            <rect x="14" y="46" width="20" height="6" rx="3" fill="white" opacity="0.5" />
          ...
          <span style={{ fontSize: 60, fontWeight: 800, color: "#f1f5f9", letterSpacing: "-2px", fontFamily: "system-ui, sans-serif" }}>Frontier<span style={{ color: "#2563eb" }}>Ops</span></span>
        </div>
        ...
        <div style={{ opacity: ctaSpring, transform: `scale(${0.9 + ctaSpring * 0.1})`, display: "flex", flexDirection: "column", alignItems: "center", gap: 14 }}>
          <div style={{ background: "linear-gradient(135deg, #1d4ed8 0%, #7c3aed 100%)", borderRadius: 14, padding: "18px 48px", boxShadow: "0 8px 32px rgba(37,99,235,0.35)" }}>
            <span style={{ fontSize: 24, fontWeight: 700, color: "#fff", fontFamily: "system-ui, sans-serif" }}>frontierops.business</span>
          </div>
          <p style={{ fontSize: 16, color: "#475569", margin: 0, fontFamily: "system-ui, sans-serif" }}>Get in touch to get started</p>
        </div>
      </AbsoluteFill>
    </AbsoluteFill>
  );
