...
Source: https://unifdata-nkm6jb5ju-tdrizzs-projects.vercel.app
...
| `extracted/tokens.json` | Design tokens: 7 colors, 5 fonts, 1 headings, 1 CTAs |
...
- **Colors**: #171717, #FAFAFA, #FFFFFF, #EBEBEB, #0072F5, #888888, #000000
- **Fonts**: Geist Mono (100-900 variable), Geist (100-900 variable), Space Mono (400), Space Grotesk (400,500), Roboto Mono (400,500,700)
